            ...
            <div className={`phone-1-item`}>
              ...
              >
                <Image alt="pucceu / phone photography" //width={300} 
                  src="/assets/photography/2019-01.png" className={`phone-photo-item`}
                />
                <Image alt="pucceu / phone photography" //width={300} 
                  src="/assets/photography/2019-02.png" className={`phone-photo-item`}
                />
                <Image alt="pucceu / phone photography" //width={300} 
                  src="/assets/photography/2019-03.png" className={`phone-photo-item`}
                />
              </Image.PreviewGroup>
            </div>
          </div>
